...
import "package:q_tools/serialize.dart";

class Context {
  final String uri;
  const Context(this.uri);
}
...
class Person {
  ...
  Person.fromValues(this.a, this.b);
...
main() {
  ...
  test("Round trip test", () {
    var input = new Person.fromValues(
        "one", new Person.fromValues(2, [3, new Person.fromValues(4, 5)]));
  ...
  test("Serialize subtype", () {
    var input = new Person.fromValues(1, new B.fromValues(1, 2, 3));
